...
import com.leo.core.myutil.ArrayUtil;
import com.leo.core.myutil.ClassUtil;
...
import com.leo.modules.LoadServiceImpl;
...
public class InitListener implements ServletContextAware, ApplicationListener<ContextRefreshedEvent> {
	...
	private final static String projectPackage="com.leo";
    
	private final static String daoPackage="com.leo";
...
//            message.getMailTo().add("retraindev@leo.com");
