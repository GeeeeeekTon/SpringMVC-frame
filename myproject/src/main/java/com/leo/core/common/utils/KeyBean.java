...
public class KeyBean {
     ...
     * md5加密
     * @param inbuf 明文
     * @param length 长度(32,16,64)
     * @return
     */
    public String getMd5Str(String inbuf, int length){
        if(length <= 0){
            return null;
        }else if(length == 16){
            String MD5Str32 = getkeyBeanofStr(inbuf);
            return MD5Str32.substring(8, 24);
        }else if(length == 32){
            return getkeyBeanofStr(inbuf);
        }
