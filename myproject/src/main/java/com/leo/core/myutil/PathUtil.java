...
public class PathUtil {
	 ...
	 * @return
	 */
	public static boolean isFileType(String fileName, FileType fileType) {
		boolean flag = false;
		switch (fileType) {
		case EXCEL:
			flag = ArrayUtils.contains(new String[]{".XLSX",".XLS"}, StringUtils.upperCase(getExtension(fileName)));
			break;
		default:
			break;
		}
	...
	public static void main(String[] args) {
		...
		System.out.println(isFileType("abc.xLs", FileType.EXCEL));
		System.out.println(isFileType("abc.xls", FileType.EXCEL));
		System.out.println(isFileType("abc.xLSx", FileType.EXCEL));
		System.out.println(isFileType("abc.txt", FileType.EXCEL));
		System.out.println(getExtension("abc.txt"));
	}
}
