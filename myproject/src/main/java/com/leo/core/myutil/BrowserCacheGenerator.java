...
public class BrowserCacheGenerator extends WebApplicationObjectSupport {
	 ...
	 */
	public BrowserCacheGenerator(boolean restrictDefaultSupportedMethods) {
	 ...
	 */
	public BrowserCacheGenerator(String... supportedMethods) {
	 ...
	 */
	public void checkAndPrepare(HttpServletRequest request, HttpServletResponse response, int cacheSeconds, boolean lastModified)
