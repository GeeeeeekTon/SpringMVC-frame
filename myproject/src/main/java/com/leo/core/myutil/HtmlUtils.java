...
public abstract class HtmlUtils {
	...
	public static void main(String[] args) {
		System.out.println(htmlUnescape((htmlEscapeDecimal("<span>leo</span>")))+":"+htmlEscapeDecimal("<span>leo</span>"));
		System.out.println(htmlUnescape((htmlEscapeHex("<span>leo</span>")))+":"+htmlEscapeHex("<span>leo</span>"));
		System.out.println(htmlUnescape(htmlEscape("<span>leo</span>"))+":"+htmlEscape("<span>leo</span>"));
	}
}
