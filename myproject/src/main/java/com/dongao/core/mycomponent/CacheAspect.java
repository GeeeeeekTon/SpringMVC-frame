...
import com.dongao.core.mycache.Expiry;
...
import com.dongao.core.mycache.util.SerializationUtils;
...
import com.dongao.core.myutil.KeyLock;
...
public class CacheAspect implements Ordered {
	...
	public static final String loadPrefix="load";//reference com.dongao.rbc.service.LoadService
	...
	@Around("com.dongao.core.mycomponent.DongaoNamePointcut.cacheCut()")
