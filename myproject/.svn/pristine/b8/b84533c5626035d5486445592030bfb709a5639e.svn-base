...
<body>
	<div class="form">
		<form class="addForm" target="_top" id="sampleTestAddForm" action="${request.getContextPath()}/sample/sampleTest/saveSampleTest" method="post">
			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%" style="margin-top:20px;" class="boxTable boxmar">
					<tr>
		            	<td align="right" style="width:80px"><span class="check">*</span>登录名：</td>
		      			<td style="width:150px">
		      				<input name="loginName" id="loginName" class="cword"   datatype="s2-16" nullmsg="请输入登录名！" errormsg="登录名至少2个字符,最多16个字符！"/>
		            	</td>
		            	<td>
					...
					<tr>
		            	<td align="right" style="width:80px"><span class="check">*</span>密码：</td>
		      			<td style="width:150px">
		      				<input name="password" id="password" class="cword"   datatype="s2-16" nullmsg="请输入密码！" errormsg="密码至少2个字符,最多16个字符！"/>
		            	</td>
		            	<td>
	    					<div class="Validform_checktip"></div>
	    				</td>
		            ...
		            <tr>
		            	<td align="right" style="width:80px"><span class="check">*</span>类型：</td>
		      			<td style="width:150px">
		      				<input name="type" id="type" class="cword" />
		            	</td>
		            	<td>
	    					<div class="Validform_checktip"></div>
	    				</td>
