package com.dongao.modules.sample.model;

import com.dongao.core.base.pojo.BasePojo;
...
public class SampleTest extends BasePojo implements java.io.Serializable {
