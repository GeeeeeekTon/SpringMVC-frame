...
public abstract class HtmlUtils {
	...
	public static void main(String[] args) {
		System.out.println(htmlUnescape((htmlEscapeDecimal("<span>dongao</span>")))+":"+htmlEscapeDecimal("<span>dongao</span>"));
		System.out.println(htmlUnescape((htmlEscapeHex("<span>dongao</span>")))+":"+htmlEscapeHex("<span>dongao</span>"));
		System.out.println(htmlUnescape(htmlEscape("<span>dongao</span>"))+":"+htmlEscape("<span>dongao</span>"));
	}
}
