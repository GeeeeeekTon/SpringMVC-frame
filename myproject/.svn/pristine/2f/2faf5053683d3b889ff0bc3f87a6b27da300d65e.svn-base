...
public class Base64 {
	...
	public static byte[] encodeToByte(String s) {
		try {
			return encodeToByte(s.getBytes(Constants.UTF8), false);
	...
	public static byte[] encodeToByte(String s, boolean lineSep) {
		try {
			return encodeToByte(s.getBytes(Constants.UTF8), lineSep);
		} catch (UnsupportedEncodingException ignore) {
			return null;
		}
	}
	...
	public static String decodeToString(byte[] arr) {
		try {
			return new String(decode(arr), Constants.UTF8);
		} catch (UnsupportedEncodingException ignore) {
			return null;
		}
	}
	...
	public static String encodeToString(String s) {
		try {
			return new String(encodeToChar(s.getBytes(Constants.UTF8), false));
		} catch (UnsupportedEncodingException ignore) {
			return null;
		}
	}
	...
	public static String encodeToString(String s, boolean lineSep) {
		try {
			return new String(encodeToChar(s.getBytes(Constants.UTF8), lineSep));
		} catch (UnsupportedEncodingException ignore) {
			return null;
		}
	}
	...
	public static String decodeToString(String s) {
		try {
			return new String(decode(s), Constants.UTF8);
		} catch (UnsupportedEncodingException ignore) {
			return null;
		}
	}
	...
	public static void main(String[] args) {
		System.out.println(decodeToString(encodeToString("ABCwefe张%$C震")));
	}
