...
import com.dongao.core.mycache.redis.RedisCacheProvider;
...
class CacheManager {
	...
	private final static String CONFIG_FILE = "/config/j2cache/j2cache.properties";

	private static CacheProvider l1_provider;//ehcache TODO 
	private static CacheProvider l2_provider;//redis
